      ...
      <View className='g-intro'>
        ...
        <View className='m-sect'>
          ...
          <View className="m-intro">
            <Text className="m-p"><Text className="r">浙江艾尔森环保科技有限公司</Text>由中科院博士生团队支持创办，采用国际专利技术，主要研发和生产垃圾处理设备、甲醛治理液、异味清除剂、新风系统设备及含酶净化网等空气净化灭菌产品，是一家集研发设计、生产销售服务一体化专业环保公司。</Text>
            <Text className="m-p">艾尔森拥有空气净化方面的多项自主知识产权产品，而且属于<Text className="r">浙江省室内环境净化行业协会会长单位</Text>、国家级二青会室内环境治理技术委员单位、浙江省科技型企业、2020被评为<Text className="b">突出贡献单位</Text>，已通过<Text className="b">ISO9001管理体系认证</Text>。</Text>
            <Text className="m-p">2019年艾尔森携手<Text className="r">世界500强企业霍尼韦尔</Text>在杭州成立浙江营销中心，共享核心技术。2020年初，新冠肺炎疫情期间累计向杭城捐赠百吨消毒物资，为杭城各区多所中小学校进行了公益消毒灭菌服务，受到了各区教育局的嘉奖及表扬。我们重新定义美好生活，致力于给用户提供健康环保的产品，改善空气环境、提高生活质量，用呼吸、传递爱！</Text>
          </View> 
        </View>
        <View className="m-logo m-logo2">
          <Image src="https://mooc.hznu.edu.cn/cdn/intro_main02.png"></Image>
        </View> 
        <View className='m-sect'>
          <View className="m-title">
